...
Obtain the estimate keeping all other variables fixed. The estimate for solving homicides comparing male victims to female victims is 0.854.
```{r}
Baltimore_fit %>%
  broom::tidy() %>%
...
Run glm for each cities in my dataset. 
```{r}
all_fit = homicide %>%
